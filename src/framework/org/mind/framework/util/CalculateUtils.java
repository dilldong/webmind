...
public class CalculateUtils {
    ...
    public static String format(String number, RoundingMode mode, int scale) {
        String afterPart = StringUtils.substringAfter(number, IOUtils.DOT);
    ...
    public static String formatNumberSymbol(String amount) {
        String intpart = StringUtils.substringBefore(amount, IOUtils.DOT);
        ...
        if (size > 3) {
            ...
            String decimals = StringUtils.substringAfter(amount, IOUtils.DOT);
            return StringUtils.isEmpty(decimals) ?
                    str.append(newChars).toString() :
                    str.append(newChars).append(IOUtils.DOT).append(decimals).toString();
        }
